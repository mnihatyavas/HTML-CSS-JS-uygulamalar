   ...
   this.canvas.lineWidth = this.sliverWidth;
    ...
    this.loadMap = function(m, x, y) {
        ...
        if (parseOk) {
            ...
            trace("oyuncu kamera konumu [x,y]=[" +this.camera.position._x +"," +this.camera.position._y +"]");
        }
        return parseOk;
    }
